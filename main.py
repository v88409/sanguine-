...
# Comma-separated user IDs, e.g. "5840594311,123456789"
auth_users = [
    int(uid.strip())
...
def run_flask():
    port = int(os.environ.get("PORT", 10000))  # Render automatically PORT set karta hai
